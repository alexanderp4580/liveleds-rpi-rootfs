...
double cblas_dsdot(const int N, const float *X, const int incX, const 
float *Y,
                   const int incY);
...
void cblas_drot(const int N, double *X, const int incX,
                double *Y, const int incY, const double c, const double  
s);
 ...
 */
void cblas_sscal(const int N, const float alpha, float *X, const int 
incX);
void cblas_dscal(const int N, const double alpha, double *X, const int 
incX);
void cblas_cscal(const int N, const void *alpha, void *X, const int incX);
void cblas_zscal(const int N, const void *alpha, void *X, const int incX);
void cblas_csscal(const int N, const float alpha, void *X, const int 
incX);
void cblas_zdscal(const int N, const double alpha, void *X, const int 
incX);
...
void cblas_sgbmv(CBLAS_LAYOUT layout,
                 ...
                 const int incX, const float beta, float *Y, const int 
incY);
...
void cblas_dgbmv(CBLAS_LAYOUT layout,
                 ...
                 const int incX, const double beta, double *Y, const int 
incY);
...
void cblas_dtpmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo,
                 CBLAS_TRANSPOSE TransA, CBLAS_DIAG Diag,
                 const int N, const double *Ap, double *X, const int 
incX);
...
void cblas_cgbmv(CBLAS_LAYOUT layout,
                 ...
                 const int incX, const void *beta, void *Y, const int 
incY);
...
void cblas_ssbmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo,
                 const int N, const int K, const float alpha, const float 
*A,
                 const int lda, const float *X, const int incX,
                 const float beta, float *Y, const int incY);
...
void cblas_dger(CBLAS_LAYOUT layout, const int M, const int N,
                ...
                const double *Y, const int incY, double *A, const int 
lda);
...
void cblas_dsyr2(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo,
                const int N, const double alpha, const double *X,
                const int incX, const double *Y, const int incY, double 
*A,
                const int lda);
...
void cblas_chbmv(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo,
                 const int N, const int K, const void *alpha, const void 
*A,
                 const int lda, const void *X, const int incX,
                 const void *beta, void *Y, const int incY);
...
void cblas_cher(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo,
                const int N, const float alpha, const void *X, const int 
incX,
...
void cblas_zher(CBLAS_LAYOUT layout, CBLAS_UPLO Uplo,
                const int N, const double alpha, const void *X, const int 
incX,
                void *A, const int lda);
